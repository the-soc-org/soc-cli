...
# GitHub-specific implementation for the SoC CLI.
...
echo "${YUP} The file ${user_config_path} has been created."
  ...
  echo " The file ${user_config_path} already exists."
fi
